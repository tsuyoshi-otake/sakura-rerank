...
# Commit E deliberately leaves the verified identity allowlist and trusted
# metadata empty.  Commit F may add exactly one measured Commit E/binary pair.
# A pinned Sakura Input HEAD alone is never an exporter identity: the
# production converter bound remains 18, while this research binary is
# isolated behind the Sakura Input research-top32 feature and patch.
