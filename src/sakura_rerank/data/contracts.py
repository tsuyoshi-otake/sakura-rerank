...
# Commit F pins exactly one measured Commit E/binary pair.  The pinned Sakura
# Input HEAD alone is never an exporter identity: the production converter
# bound remains 18, while this research binary is isolated behind the Sakura
# Input research-top32 feature and patch.
